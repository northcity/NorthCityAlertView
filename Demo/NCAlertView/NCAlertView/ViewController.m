...
#import "NCAlertView/Classes/NCAlertView.h"
#import "NCAlertView/Classes/NCSuperVipAlertView.h"
...
//    });
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        NCSuperVipAlertView *ncview = [[NCSuperVipAlertView alloc]initWithFrame:[UIScreen mainScreen].bounds];
        [ncview showSuperVipAlertViewWithTitle:@"我稍后" content:@"" redText:@"" knowButton:@"￥6/月永久获取" huiFuButton:@"恢复资格" imageName:@""];
